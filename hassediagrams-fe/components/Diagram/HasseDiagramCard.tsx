...
export default function HasseDiagramCard({ diagramID, userID, numberOfElements, numberOfNodes, numberOfEdges, diagramName }: CardProps) {
    return (
        <Link href={`/diagrams/${encodeURIComponent(diagramID)}`} className="inline-block m-4">
            <div className="w-72 flex flex-col bg-[var(--itemsbackground)] p-4 rounded-lg 
